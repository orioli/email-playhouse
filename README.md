...
⌨️⌨️ [**1.2**](https://github.com/S-quark1/TabTabGo_1.2.0): Double hand operated, pane based (Chrome plugin, optimized for Gmail web only).

🎥 [**Video Demo**](https://www.youtube.com/watch?v=IldTUvdUWKg): Implementation and workflow overview of the ecological task protocol.
