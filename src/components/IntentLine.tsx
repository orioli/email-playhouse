      ...
      switch (type) {
        ...
        case 'cancel':
          ...
          if (!cancelButton) {
            ...
            cancelButton.innerHTML = '<div style="color: #ef4444; margin-bottom: 4px;">TO CANCEL: LIFT X, THEN Z</div><div style="color: #10b981; margin-bottom: 4px;">TO ACCEPT: LIFT Z X AT SAME TIME</div><div style="color: #3b82f6;">NEXT OPTION: Z X + SPACE BAR</div>';
