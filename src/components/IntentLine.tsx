...
export const IntentLine = ({ sensitivity = 70, easeIn = 200, onChordActivated, onActionConfirmed, onLineCreated, onSuggestionDiscarded }: { sensitivity?: number; easeIn?: number; onChordActivated?: () => void; onActionConfirmed?: (cursorPos: {x: number, y: number}, buttonType: string) => void; onLineCreated?: (distance: number) => void; onSuggestionDiscarded?: () => void }) => {
        ...
        const animateLineOut = () => {
          ...
          if (progress < 1 && originalLine) {
            ...
            setTimeout(() => {
              ...
              onActionConfirmed?.(cursorPos, targetButtonType);
            }, 250);
          }
        };
